...
public class GridView extends BaseAdapter {
    ...
    private List<Hasil> urls = new ArrayList<Hasil>();


    public GridView(Context context, List<Hasil> urls) {
    ...
    @Override
    public Hasil getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Hasil hasil = getItem(position);

        Glide.with(context) //
                .load(hasil.getPoster_path()) //
