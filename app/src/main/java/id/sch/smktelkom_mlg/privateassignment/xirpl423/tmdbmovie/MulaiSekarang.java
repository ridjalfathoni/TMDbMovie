...
public class MulaiSekarang extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_mulai_sekarang, container, false);
        MulaiSekarang.FetchMovies fetchMovies = new MulaiSekarang.FetchMovies();
    ...
    public class FetchMovies extends AsyncTask<String, Void, List<Hasil>> {
        ...
        private final String LOG_TAG = MulaiSekarang.FetchMovies.class.getSimpleName();
